...
namespace ReachBeyond.VariableObjects.Editor {
	...
	public class GameObjectRefEditor : Base.Editor.RefEditor { }

	[CustomPropertyDrawer(typeof(GameObjectConstReference))]
	public class GameObjectConstRefEditor : Base.Editor.ConstRefEditor { }
}
