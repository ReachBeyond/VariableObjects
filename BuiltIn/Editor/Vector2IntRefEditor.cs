...
namespace ReachBeyond.VariableObjects.Editor {
	...
	public class Vector2IntRefEditor : Base.Editor.RefEditor { }

	[CustomPropertyDrawer(typeof(Vector2IntConstReference))]
	public class Vector2IntConstRefEditor : Base.Editor.ConstRefEditor { }
}
