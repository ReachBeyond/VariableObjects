...
namespace ReachBeyond.VariableObjects.Editor {
	...
	public class Vector4RefEditor : Base.Editor.RefEditor { }

	[CustomPropertyDrawer(typeof(Vector4ConstReference))]
	public class Vector4ConstRefEditor : Base.Editor.ConstRefEditor { }
}
